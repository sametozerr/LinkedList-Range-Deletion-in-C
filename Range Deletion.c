...
struct node * deleteNodes(struct node * start, int first, int last)  
{
    ...
    /* p: Düðümler arasýnda gezinmemizi saðlar.
    /* preFirst: Silinecek olan ilk düðümden önceki düðümü içerisinde tutar.
    /* temp: Silinecek olan düðümü içerisinde tutar.
    /* position: Silinecek olan düðümün pozisyonunu içerisinde tutar.
    ...
    */
    ...
    // Silinecek olan ilk düðümden önceki düðümü bulmaya çalýþýyoruz.
